...
`)}updated(e){e.has("sendAPICall")&&this.sendAPICall&&this.handleAPICallTrigger(),e.has("submitHidden")&&this.toggleSubmitButtonVisibility(),e.has("btnVisible")&&(console.log(`[UI Property Change] btnVisible changed to: ${this.btnVisible}`),this.requestUpdate()),e.has("btnEnabled")&&(console.log(`[UI Property Change] btnEnabled changed to: ${this.btnEnabled}`),this.requestUpdate()),e.has("btnText")&&(console.log(`[UI Property Change] btnText changed to: ${this.btnText}`),this.requestUpdate()),e.has("btnAlignment")&&(console.log(`[UI Property Change] btnAlignment changed to: ${this.btnAlignment}`),this.requestUpdate()),e.has("debugMode")&&(console.log(`[UI Property Change] debugMode changed to: ${this.debugMode}`),this.requestUpdate())}toggleSubmitButtonVisibility(){let e="ntx-submit-button-hidden-style";if(this.submitHidden){if(!document.getElementById(e)){let t=document.createElement("style");t.id=e,t.textContent=`
    ...
    `}getPreviewForConfig(e,t){if(!e||e.trim().length===0)return p`<span style="font-style: italic; opacity: 0.6;">No configuration set</span>`;let r=this.value,i=V(w({},this.value),{data:JSON.stringify(t)});this.value=i;let o;if(e.trim().startsWith('{"fields"')||e.trim().startsWith('"{'))try{let a;if(e.startsWith('"{')&&e.endsWith('}"')){let l=e.slice(1,-1).replace(/\\"/g,'"');a=JSON.parse(l)}else a=JSON.parse(e);o=this.formatResponseWithConfig(a)}catch(a){o=e}else o=e;return this.value=r,o}loadConfigIntoFields(e){let t=e==="success"?this.successMessage:e==="warning"?this.warningMessage:this.errorMessage;if(this.formatterSelectedFields.clear(),!t||t.trim().length===0){this.requestUpdate();return}try{let r;if(t.startsWith('"{')&&t.endsWith('}"')){let i=t.slice(1,-1).replace(/\\"/g,'"');r=JSON.parse(i)}else if(t.trim().startsWith('{"fields"'))r=JSON.parse(t);else{this.requestUpdate();return}r.fields&&Array.isArray(r.fields)&&r.fields.forEach((i,o)=>{this.formatterSelectedFields.set(i.path,{title:i.title||i.path,checked:!0,order:o})})}catch(r){console.error("[Config Loading] Failed to parse config:",r)}this.requestUpdate()}renderAvailableFields(e,t){let r=[],i=(o,a)=>{o&&typeof o=="object"&&!Array.isArray(o)&&Object.keys(o).forEach(l=>{var u,b;let d=a?`${a}.${l}`:l,c=o[l];if(Array.isArray(c)&&c.length>0){if(this.formatterUseArrayNotation){let m=`${d}[*]`,v=((u=this.formatterSelectedFields.get(m))==null?void 0:u.checked)||!1,A=`Array with ${c.length} item${c.length>1?"s":""}`;r.push(p`
      ...
      <div 
        ...
        @drop=${o=>{o.preventDefault();let a=parseInt(o.dataTransfer.getData("text/plain")),l=i;if(a!==l){let d=Array.from(e),[c]=d.splice(a,1);d.splice(l,0,c),d.forEach(([u,b],m)=>{this.formatterSelectedFields.set(u,V(w({},b),{order:m}))}),this.requestUpdate()}}}
        style="
          display: flex;
          align-items: center;
          gap: 10px;
      ...
      >
        ...
        <div style="flex: 1; min-width: 0;">
          ...
          <input 
            ...
            .value=${r.title}
            @input=${o=>{let a=o.target;this.formatterSelectedFields.set(t,V(w({},r),{title:a.value})),this.requestUpdate()}}
