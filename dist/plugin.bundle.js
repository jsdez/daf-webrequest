        ...
        <tbody>
          ${s.map(o=>h`
            <tr>
              ...
              <td class="value-current">${this.formatValue(o.current)}</td>
            </tr>
          `)}
        </tbody>
      </table>
    ...
    `}renderFieldSelector(e,s){let o=[],i=(r,a)=>{r&&typeof r=="object"&&!Array.isArray(r)&&Object.keys(r).forEach(l=>{var p,g;let c=a?`${a}.${l}`:l,d=r[l];if(d!==null&&typeof d!="object"){let b=c,v=((p=this.formatterSelectedFields.get(b))==null?void 0:p.checked)||!1,Ue=((g=this.formatterSelectedFields.get(b))==null?void 0:g.title)||"";o.push(h`
              <div style="display: flex; align-items: center; margin-bottom: 12px; gap: 12px;">
                <input 
                  type="checkbox" 
                  .checked=${v}
                  @change=${K=>{let G=K.target,Z=this.formatterSelectedFields.get(b)||{title:"",checked:!1};this.formatterSelectedFields.set(b,H($({},Z),{checked:G.checked})),this.requestUpdate()}}
                ...
                ${v?h`
                  <input 
                    ...
                    .value=${Ue}
                    @input=${K=>{let G=K.target,Z=this.formatterSelectedFields.get(b)||{title:"",checked:!1};this.formatterSelectedFields.set(b,H($({},Z),{title:G.value})),this.requestUpdate()}}
