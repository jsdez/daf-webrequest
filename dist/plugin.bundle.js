...
`)}updated(e){e.has("value")&&(console.log("[Updated Lifecycle] Value property changed, dispatching ntx-value-change event"),this.dispatchEvent(new CustomEvent("ntx-value-change",{detail:this.value,bubbles:!0,composed:!0}))),e.has("sendAPICall")&&this.sendAPICall&&this.handleAPICallTrigger(),e.has("submitHidden")&&this.toggleSubmitButtonVisibility(),e.has("btnVisible")&&(console.log(`[UI Property Change] btnVisible changed to: ${this.btnVisible}`),this.requestUpdate()),e.has("btnEnabled")&&(console.log(`[UI Property Change] btnEnabled changed to: ${this.btnEnabled}`),this.requestUpdate()),e.has("btnText")&&(console.log(`[UI Property Change] btnText changed to: ${this.btnText}`),this.requestUpdate()),e.has("btnAlignment")&&(console.log(`[UI Property Change] btnAlignment changed to: ${this.btnAlignment}`),this.requestUpdate()),e.has("debugMode")&&(console.log(`[UI Property Change] debugMode changed to: ${this.debugMode}`),this.requestUpdate())}toggleSubmitButtonVisibility(){let e="ntx-submit-button-hidden-style";if(this.submitHidden){if(!document.getElementById(e)){let s=document.createElement("style");s.id=e,s.textContent=`
    ...
    `}renderAvailableFields(e,s){let o=[],i=(r,a)=>{r&&typeof r=="object"&&!Array.isArray(r)&&Object.keys(r).forEach(l=>{var u;let d=a?`${a}.${l}`:l,c=r[l];if(c!==null&&typeof c!="object"){let g=d,y=((u=this.formatterSelectedFields.get(g))==null?void 0:u.checked)||!1;o.push(p`
      ...
      >
        ...
        <div style="flex: 1; min-width: 0;">
          ...
          <input 
            ...
            .value=${o.title}
            @input=${r=>{let a=r.target;this.formatterSelectedFields.set(s,H($({},o),{title:a.value})),this.requestUpdate()}}
