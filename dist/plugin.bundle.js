    ...
    `}renderFieldSelector(e,s){let o=[],i=(r,a)=>{r&&typeof r=="object"&&!Array.isArray(r)&&Object.keys(r).forEach(l=>{var u,g;let c=a?`${a}.${l}`:l,d=r[l];if(d!==null&&typeof d!="object"){let y=c,v=((u=this.formatterSelectedFields.get(y))==null?void 0:u.checked)||!1,Ve=((g=this.formatterSelectedFields.get(y))==null?void 0:g.title)||"";o.push(p`
              <div style="display: flex; align-items: center; margin-bottom: 12px; gap: 12px;">
                <input 
                  type="checkbox" 
                  .checked=${v}
                  @change=${K=>{let G=K.target,Z=this.formatterSelectedFields.get(y)||{title:"",checked:!1};this.formatterSelectedFields.set(y,H($({},Z),{checked:G.checked})),this.requestUpdate()}}
                ...
                ${v?p`
                  <input 
                    ...
                    .value=${Ve}
                    @input=${K=>{let G=K.target,Z=this.formatterSelectedFields.get(y)||{title:"",checked:!1};this.formatterSelectedFields.set(y,H($({},Z),{title:G.value})),this.requestUpdate()}}
