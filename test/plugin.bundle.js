...
`)}function Kn(r,e){return r?Object.entries(r).filter(([t])=>t!=="value"&&!e.has(t)).map(([t,s])=>({name:t,default:s.defaultValue,config:s})):[]}function zr(r,e,t){let s=Kn(r,t);return y`
      ...
      <tbody>
        ${s.map(n=>y`
          <tr>
            ...
            <td class="value-current">${Qn(n.name,n.config,e)}</td>
          </tr>
        `)}
      </tbody>
    </table>
  `}function Qn(r,e,t){let s=t[r],n=e.type;if(n==="boolean")return y`
...
${t}<span class="json-syntax-punctuation">}</span>`}return String(r)}function Br(r,e){let t=U(r),s=jr(r);return y`
  ...
  `}function Xn(r,e){let t=[];return r.forEach((s,n)=>{if(!s.checked)return;let i=L(e,n);t.push({title:s.title||n,value:i!==void 0?String(i):"N/A"})}),t}function Zr(r,e){let t=Xn(r,e);return t.length===0?y`<div style="color: var(--ntx-form-theme-color-secondary); font-style: italic;">No fields selected</div>`:t.map(s=>y`
