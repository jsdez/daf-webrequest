...
`)}function Fs(r,e){return r?Object.entries(r).filter(([t])=>t!=="value"&&!e.has(t)).map(([t,s])=>({name:t,default:s.defaultValue,config:s})):[]}function wr(r,e,t){let s=Fs(r,t);return y`
      ...
      <tbody>
        ${s.map(n=>y`
          <tr>
            ...
            <td class="value-current">${Vs(n.name,n.config,e)}</td>
          </tr>
        `)}
      </tbody>
    </table>
  `}function Vs(r,e,t){let s=t[r],n=e.type;if(n==="boolean")return y`
    ...
    `}return n==="number"||n==="integer"?y`<span style="font-weight: 500;">${s}</span>`:y`<span>${Ot(s)}</span>`}function Tr(r,e){let t=a=>y`
  ...
  `}function Sr(r){if(!r.trim())return"";let e="",t="",s="";try{let n=JSON.parse(r);e=JSON.stringify(n),t=`"${e.replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}catch(n){s=n.message}return y`
  ...
  `}function Ar(r){if(!r.trim()||!V(r))return"";try{let e=JSON.parse(r);return y`
      <div class="form-group">
...
`)}
${t}<span class="json-syntax-punctuation">}</span>`}return String(r)}function Cr(r,e){let t=V(r),s=br(r);return y`
  ...
  `}function kr(r,e){let t=r.formatterJsonInput.trim().length>0,s=t&&V(r.formatterJsonInput),n=null,i="";if(t)try{n=JSON.parse(r.formatterJsonInput)}catch(a){i=a.message}let o=(a,l)=>y`
    <button
  ...
  `}function js(r,e){let t=[];return r.forEach((s,n)=>{if(!s.checked)return;let i=F(e,n);t.push({title:s.title||n,value:i!==void 0?String(i):"N/A"})}),t}function $r(r,e){let t=js(r,e);return t.length===0?y`<div style="color: var(--ntx-form-theme-color-secondary); font-style: italic;">No fields selected</div>`:t.map(s=>y`
    <div style="margin-bottom: 8px;">
      <strong>${s.title}:</strong> ${s.value}
    </div>
  `)}function Er(r,e){return r.length===0?y`<div style="color: var(--ntx-form-theme-color-secondary); font-style: italic; padding: 12px; text-align: center;">No fields selected. Check fields from the left panel.</div>`:r.map(([t,s],n)=>y`
    <div draggable="true"
  ...
  `)}function Rr(r){switch(r){case"success":return"\u2713";case"warning":return"\u26A0";case"error":return"\u2717";default:return"\u2022"}}function Mr(r,e){return r==="Never"?!1:r==="Always"?!0:r==="On Error/Warning"&&(e==="error"||e==="warning")}function Ir(r){return r.countdownEnabled&&r.lastApiCallTime>0&&r.now-r.lastApiCallTime<r.countdownTimer*1e3&&r.showCooldownAlert?!0:!(!r.apiResponse||!r.responseType||r.lastCooldownAlertTime>r.lastApiCallTime)}function Or(r){if(!V(r))return null;try{return JSON.stringify(JSON.parse(r),null,2)}catch(e){return null}}function Nr(r){if(!V(r))return null;try{return JSON.stringify(JSON.parse(r))}catch(e){return null}}function Pr(r){return JSON.stringify({startData:{se_input:"This is a test",options:{callbackUrl:"optionally add a callback URL here. Must be https",metadata:{userId:"12345",requestId:`req-${r}`}}}},null,2)}function Fr(r){return{success:!1,valid:!1,statusCode:0,responseType:"pending",data:"",message:"",formattedResponse:"",timestamp:r,executionTime:0}}function Vr(r){let e=r.success===!0&&r.responseType==="success";return d(d({success:e,valid:e,statusCode:r.statusCode!==void 0?r.statusCode:r.responseType==="success"?200:500,responseType:r.responseType,data:r.data,message:r.message,formattedResponse:r.formattedResponse,timestamp:r.timestamp,executionTime:r.executionTime},r.accessToken&&{access_token:r.accessToken}),r.output!==void 0&&{output:r.output})}function jr(r,e,t,s){return{success:!1,valid:!1,statusCode:0,responseType:"error",data:r,message:r,formattedResponse:e,timestamp:t,executionTime:s}}function Lr(r,e,t){let s=[],n=(i,o)=>{!i||typeof i!="object"||Array.isArray(i)||Object.keys(i).forEach(a=>{let l=o?`${o}.${a}`:a,c=i[a];if(Array.isArray(c)&&c.length>0)t&&s.push({kind:"array",path:`${l}[*]`,title:a,preview:`Array with ${c.length} item${c.length>1?"s":""}`}),typeof c[0]=="object"&&!Array.isArray(c[0])&&n(c[0],t?`${l}[*]`:`${l}[0]`);else if(c!==null&&typeof c!="object"){let p=String(c);s.push({kind:"value",path:l,title:l.split(".").pop()||l,preview:p.length>50?`${p.substring(0,50)}...`:p})}else c&&typeof c=="object"&&!Array.isArray(c)&&n(c,l)})};return n(r,e),s}function Ft(r){return Array.from(r.entries()).filter(([,e])=>e.checked).sort((e,t)=>e[1].order-t[1].order)}function Ur(r,e,t,s){if(!t){r.delete(e);return}let n=-1;r.forEach(i=>{i.order>n&&(n=i.order)}),r.set(e,{title:s,checked:!0,order:n+1})}function zr(r,e,t){let s=r.get(e);s&&r.set(e,b(d({},s),{title:t}))}function Hr(r,e){r.delete(e)}function Dr(r,e,t){let s=Ft(r);if(e===t)return;let[n]=s.splice(e,1);n&&(s.splice(t,0,n),s.forEach(([i,o],a)=>{r.set(i,b(d({},o),{order:a}))}))}function Br(r,e,t){let s=e[r];if(s.startsWith('"{')&&s.endsWith('}"'))try{let n=JSON.parse(s.slice(1,-1).replace(/\\"/g,'"'));return{title:n.title||null,message:Ke(n,t)}}catch(n){return console.error("[Message Formatting] Failed to parse quoted config:",n),{title:null,message:s}}if(s.trim().startsWith('{"'))try{let n=JSON.parse(s);return{title:n.title||null,message:Ke(n,t)}}catch(n){return console.error("[Message Formatting] Failed to parse unquoted config:",n),{title:null,message:s}}return{title:null,message:s}}async function Jr(r){let e=new AbortController,t=!1,s=r.timeoutSeconds===null?null:window.setTimeout(()=>{t=!0,e.abort()},r.timeoutSeconds*1e3);try{let n=await fetch(r.tokenUrl,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"client_credentials",client_id:r.clientId,client_secret:r.clientSecret}),signal:e.signal});if(!n.ok)throw new Error(`Token request failed with status ${n.status}`);let i=await n.json();if(!i.access_token)throw new Error("No access_token in response");return{accessToken:i.access_token,debugMetadata:{token_type:i.token_type||"Bearer",expires_in:i.expires_in,scope:i.scope,fetched_at:new Date().toISOString(),expires_at:i.expires_in?new Date(Date.now()+i.expires_in*1e3).toISOString():null}}}catch(n){throw t&&r.timeoutSeconds!==null?new Error(`OAuth token request timed out after ${r.timeoutSeconds} seconds.`):n}finally{s!==null&&window.clearTimeout(s)}}function qr(r,e,t){let s=e===!1?"error":at(r),n,i,o="";try{let a=JSON.parse(r);a.access_token&&(n=a.access_token),t&&t.trim()&&(i=F(a,t)),o=F(a,"d.Message")||F(a,"Message")||F(a,"message")||F(a,"msg")||F(a,"data.message")||""}catch(a){}return{responseType:s,accessToken:n,output:i,message:o}}var Zr=bt`
    .plugin-container {
    ...
    `}getPreviewForConfig(t,s){if(!t||t.trim().length===0)return y`<span style="font-style: italic; opacity: 0.6;">No configuration set</span>`;let n=this.value,i=b(d({},this.value),{data:JSON.stringify(s)});this.value=i;let o;if(t.trim().startsWith('{"fields"')||t.trim().startsWith('"{'))try{let a;if(t.startsWith('"{')&&t.endsWith('}"')){let l=t.slice(1,-1).replace(/\\"/g,'"');a=JSON.parse(l)}else a=JSON.parse(t);o=Ke(a,this.value.data)}catch(a){o=t}else o=t;return this.value=n,o}loadConfigIntoFields(t){let s=t==="success"?this.successMessage:t==="warning"?this.warningMessage:this.errorMessage;if(this.formatterSelectedFields.clear(),this.formatterMessageTitle="",!s||s.trim().length===0){this.requestUpdate();return}try{let n=xr(s);if(!n){this.requestUpdate();return}n.title&&(this.formatterMessageTitle=n.title),n.fields&&Array.isArray(n.fields)&&n.fields.forEach((i,o)=>{this.formatterSelectedFields.set(i.path,{title:i.title||i.path,checked:!0,order:o})})}catch(n){console.error("[Config Loading] Failed to parse config:",n)}this.requestUpdate()}renderAvailableFields(t,s){let n=Lr(t,s,this.formatterUseArrayNotation);return n.length===0?y`<div style="color: var(--ntx-form-theme-color-secondary); font-style: italic; padding: 12px; text-align: center;">No fields available</div>`:n.map(i=>{var a;let o=((a=this.formatterSelectedFields.get(i.path))==null?void 0:a.checked)||!1;return y`
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px; padding: 8px; border-radius: 4px; background: ${o?"var(--ntx-form-theme-color-primary-light, #e3f2fd)":"transparent"}; transition: background 0.2s;">
          <input
            type="checkbox"
            .checked=${o}
            @change=${l=>{let c=l.target;Ur(this.formatterSelectedFields,i.path,c.checked,i.title),this.requestUpdate()}}
